...
gt_folder_path = os.path.join('data/lerf_sam',dataset_name,'test_mask')
# You can change pred_folder_path to your output
pred_folder_path = os.path.join('output/lerf_sam',dataset_name, 'test', 'ours_30000_text', 'test_mask')
