...
class GaussianModel:
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, spatial_lr_scale : float):
        ...
        fused_objects = RGB2SH(torch.rand((fused_point_cloud.shape[0],self.dim_objects), device="cuda"))
    ...
    def extraction_setup(self, training_args, mask3d):
    ...
    def load_ply(self, path):
        ...
        objects_dc = np.zeros((xyz.shape[0], self.dim_objects, 1))
        for idx in range(self.dim_objects):
